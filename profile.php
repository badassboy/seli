...
if (isset($_SESSION['id'])) {
  ...
  $userDetails = $profile->fetch_user_detail($userId);
...
if (isset($_POST['reset']) && isset($_SESSION['id'])) {
  ...
  $change = $profile->change_password($userId,$new_password,$confirm_password);
  if ($change) {
    echo "success";
  }else {
    echo "failed";
...
<div class="container bootstrap snippet">
      ...
      <br>
    	...
    	<div class="col-sm-9">
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#settings">Change Email</a></li>
              </ul>
    ...
    <div class="col-xs-6">
        ...
        <input type="text" class="form-control" name="first_name" id="first_name" placeholder="<?php echo $firstName; ?>" readonly>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-xs-6">
      <label for="last_name"><h4>Gender</h4></label>
        <input type="text" class="form-control"  id="last_name" placeholder="<?php echo $gender; ?>" readonly>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-xs-6">
        ...
        <input type="text" class="form-control" name="phone" id="phone" placeholder="<?php echo $phone; ?>" readonly>
    </div>
</div>
...
<div class="form-group">
    <div class="col-xs-6">
       <label for="mobile"><h4>Mobile</h4></label>
        <input type="text" class="form-control" name="mobile" id="mobile" placeholder="<?php ?>" readonly>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-xs-6">
        ...
        <input type="email" class="form-control" placeholder="<?php echo $city; ?>" readonly>
    </div>
</div>
  ...
  <div class="form-group">
       <div class="col-xs-12">
  <br>
	<button class="btn btn-lg btn-success" name="reset" type="submit"><i class="glyphicon glyphicon-ok-sign"></i> Save</button>
           	<!-- <button class="btn btn-lg" type="reset"><i class="glyphicon glyphicon-repeat"></i> Reset</button> -->
        </div>
  </div>
              	</form>
             ...
             <div class="tab-pane" id="settings">
                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      <div class="form-group">
                          ...
                          <!-- <div class="col-xs-6"> -->
                              <label for="first_name"><h4>New email</h4></label>
