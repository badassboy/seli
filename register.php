...
<!-- end of nav -->
    ...
    <form class="form-signin" method="post">
     ...
     <div class="row">
      ...
      <div class="col">
        <label for="inputText" class="sr-only">Country</label>
...
<select class="form-control" id="country" name="country">
    ...
    <option value="Zimbabwe">Zimbabwe</option>
      ...
      <!-- <input type="text" name="country" id="inputText" class="form-control" placeholder="Country" required> -->
      </div>

      <div class="col">
         <label for="inputEmail" class="sr-only">Date</label>
      <input type="date" name="register_date" id="inputEmail" class="form-control" required autofocus>
      </div>
    ...
    <br>
        ...
        <div class="col">
           <label for="inputPassword" class="sr-only">Second phone number(optional)</label>
      <input type="text" name="phone" id="inputPassword" class="form-control" placeholder="Secondary Phone(optional)">
        ...
        <br>
          ...
          <div class="row">
          <div class="col">
              <label for="current_job" class="sr-only">Current job</label>
      <input type="text" name="current_job" id="current_job" class="form-control" placeholder="Current Job" required autofocus>
          </div>

          <div class="col">
             <label for="dream_job" class="sr-only">Dream job</label>
      <input type="text" id="dream_job" class="form-control" placeholder="Dream job" required>
            <!-- <input type="text" class="form-control" placeholder="Last name"> -->
          </div>
        </div>
        <br>
     ...
     <!--  <div class="checkbox mb-3">
      ...
      <button class="btn btn-lg  btn-block" name="signup" type="submit"
       style="background-color: #005C46; color: white;">Sign up</button>
      <!-- <p class="mt-5 mb-3 text-muted">&copy; 2017-2018</p> -->

      <p class="expo">Already registered? <a href="login.php">Login Here</a></p>
    </form>
    <!-- end of form -->
